...
def augment_smpl(orig_shape, pose, global_orients,
    ...
    :param augment: boolean flag to control whether shape augmentation is performed.
    """
    augment_shape = smpl_augment_params['augment_shape'] and augment  # Only augment if both flags are True
