...
def main():
    ...
    parser.add_argument("--train_path", type=str, default="data/amass_up3d_3dpw_train.npz", help="Path to the training data")
    ...
    smpl_augment_params = {'augment_shape': augment_shape, 'delta_betas_distribution': delta_betas_distribution, 'delta_betas_std_vector': delta_betas_std_vector, 'delta_betas_range': delta_betas_range}
    
    # Camera
    xy_std = 0.05
    delta_z_range = [-5, 5]
    cam_augment_params = {'xy_std': xy_std, 'delta_z_range': delta_z_range}

    # BBox
    crop_input = False #True
    ...
    print(extracted_name) # coco_train_eft_v2
